...
docker run --detach --publish  850:80   --rm islasgeci/tamanio-poblacional-aves-marinas_front
docker run --detach --publish  851:4000 --rm islasgeci/tamanio-poblacional-aves-marinas_api-datos
docker run --detach --publish  852:5000 --rm islasgeci/tamanio-poblacional-aves-marinas_api-lambdas
